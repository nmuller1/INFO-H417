...
if __name__ == "__main__":
    files = ["../imdb/role_type.csv", "../imdb/movie_link.csv", "../imdb/aka_title.csv", "../imdb/name.csv","../imdb/cast_info.csv"]

    B = 1 * mmap.ALLOCATIONGRANULARITY
    for file in files:
        print("total en moyenne pour le fichier", file, " avec B =", B, ":", random4(file, B,10))
